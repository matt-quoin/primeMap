function csvParse(callback, year2){ 
    ...
    d3.csv("/refugeeData2013.csv", function(data){
        ...
        for(var p = 1975; p<=2013; p++){
            ...
            while(data[yearPointer].Year == yearTracker){ //data is listed by year, so continues as long as the year column is equal to yearTrakcer
            ...
            yearPointer--;
            if(yearPointer < 0)break; //break if it's the last year
